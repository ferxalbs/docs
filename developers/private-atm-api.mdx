...
description: Internal Rainy ATM endpoints used by rainy-cowork desktop integration.
icon: lock
---
...
The repository and internal code still use `rainy-cowork` naming because that was the original project name. The product name evolved to `Rainy MaTE`.
